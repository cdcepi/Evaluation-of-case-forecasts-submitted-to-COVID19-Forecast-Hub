...
### Supplement 6: Horizon specific plots
...
```{r Fig S6.1, echo=FALSE, warning=F, message=F, fig.height=12, fig.width=12}
...
```{r Fig S6.2, echo=FALSE, warning=FALSE, message=FALSE, fig.height=11, fig.width=12}
...
```{r Fig S6.3, echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=15}
