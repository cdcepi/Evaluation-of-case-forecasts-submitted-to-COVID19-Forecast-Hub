...
### WIS Over time
load(here("Data/WIS_all horizons_non large counties.rdata"))
...
p1 <-cov.plot(coverage_count1, labels_count1) +
  labs(title="County Forecasts: Size Quintile 1") +
...
p2 <-cov.plot(coverage_count2, labels_count2) +
  labs(title="County Forecasts: Size Quintile 2", 
       y="") 
...
p3 <-cov.plot(coverage_count3, labels_count3) +
  labs(title="County Forecasts: Size Quintile 3",
       x="Expected Coverage") 
...
p4 <-cov.plot(coverage_count4, labels_count4) +
  labs(title="County Forecasts: Size Quintile 4",
       y="",
       x="Expected Coverage") 
